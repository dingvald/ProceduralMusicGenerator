...
// onto the AudioEngine's ParameterBus. At every bar boundary it asks
// VariationEngine for decisions and applies them (pattern swap / track
// mute), logging each one via the optional callback.
class Sequencer {
public:
